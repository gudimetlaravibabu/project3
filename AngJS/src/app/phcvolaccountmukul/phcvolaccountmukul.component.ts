...
@Component({
  selector: 'app-phcvolaccountmukul',
  templateUrl: './phcvolaccountmukul.component.html',
  styleUrls: ['./phcvolaccountmukul.component.scss']
})
export class PhcvolaccountmukulComponent implements OnInit {
