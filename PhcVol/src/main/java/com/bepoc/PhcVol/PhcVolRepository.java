...
public interface PhcVolRepository extends JpaRepository<PhcVol, Integer> {
  ...
  //  public PhcVol findAccountNameAccountTrackAccountDU(@Param("account_Name") String account_Name, @Param("account_Track") String account_Track, @Param("account_Du") String account_Du,  @Param("dm") String dm);
    ...
    @Query(value="select * from Phc_vol where account_Name = :account_Name and account_Track= :account_Track and  dm=:dm", nativeQuery = true)
    public PhcVol findAccountNameAccountTrackAccountDU(@Param("account_Name") String account_Name, @Param("account_Track") String account_Track,  @Param("dm") String dm);
   ...
   // public void updatePhcVolDBTarget(@Param("phcTarget") double phcTarget, @Param("volTarget") double volTarget, @Param("accountName") String accountName, @Param("accountTrack") String accountTrack, @Param("accountDu") String accountDu, @Param("dm") String dm);
    ...
    @Modifying
     @Query(value = "update Phc_Vol A set A.phc_target=:phcTarget, A.vol_target=:volTarget where A.account_Name= :accountName and A.account_Track= :accountTrack  and  A.dm= :dm",nativeQuery = true)
     public void updatePhcVolDBTarget(@Param("phcTarget") double phcTarget, @Param("volTarget") double volTarget, @Param("accountName") String accountName, @Param("accountTrack") String accountTrack,  @Param("dm") String dm);
    ...
    @Modifying
    @Query(value = "insert into Phc_Vol (phc_Target,vol_target,account_Name,account_Track, dm) values (:phcTarget,:volTarget,:accountName,:accountTrack, :dm)",nativeQuery = true)
    public void insertPhcVolDBTarget(@Param("phcTarget") double phcTarget, @Param("volTarget") double volTarget, @Param("accountName") String accountName, @Param("accountTrack") String accountTrack, @Param("dm") String dm);
    ...
    @Modifying
    @Query(value = "update Phc_Vol A set A.volAOD=:volAOD, A.da = :da where A.account_Name= :accountName and A.account_Track= :accountTrack  and A.dm= :dm",nativeQuery = true)
    public void updatePhcVolDBVolAOD(@Param("da") String da, @Param("volAOD") double volAOD, @Param("accountName") String accountName, @Param("accountTrack") String accountTrack,  @Param("dm") String dm);
    ...
    @Modifying
    @Query(value = "insert into Phc_Vol (vol_target,volAod,account_name,account_track,da,dm,show_textbox, show_updatebutton) values (:volTarget,:volAOD,:accountName,:accountTrack, :da,:dm,0,0)",nativeQuery = true)
    public void insertPhcVolDBVolAOD(@Param("volTarget") double volTarget, @Param("volAOD") double volAOD, @Param("accountName") String accountName, @Param("accountTrack") String accountTrack,  @Param("da") String da, @Param("dm") String dm);
    ...
    @Modifying
    @Query(value = "update Phc_Vol A, (select count(emp_name) cen from PHC where account_name=:account_Name and account_Track=:account_Track and proj_type='Production' and alloc_end_date >= CURDATE() and dm=:dm) B set A.phcaod = B.cen where A.account_Name=:account_Name and A.account_track=:account_Track and A.dm=:dm",nativeQuery = true)
    public void updatePhcVolDBPhcAOD(@Param("account_Name") String account_Name, @Param("account_Track") String account_Track,  @Param("dm") String dm);
    ...
    @Modifying
    @Query(value = "update Phc_Vol A, (select count(emp_name) cen from PHC where account_name=:account_Name and account_Track=:account_Track and proj_type='Production' and alloc_end_date >= last_day(CURDATE()) and dm=:dm) B set A.phcaol = B.cen where A.account_Name=:account_Name and A.account_track=:account_Track and A.dm=:dm",nativeQuery = true)
    public void updatePhcVolDBPhcAOL(@Param("account_Name") String account_Name, @Param("account_Track") String account_Track,  @Param("dm") String dm);
   ...
   // public void updatePhcVolDBPhcAOLFutExistsAcnt(@Param("account_Name") String account_Name, @Param("account_Track") String account_Track, @Param("account_Du") String account_Du, @Param("dm") String dm);
    @Modifying
    @Query(value = "update Phc_Vol A, (select count(emp_name) cen from PHC where account_name =:account_Name and account_Track=:account_Track and proj_type='Production' and alloc_end_date < last_day(CURDATE()) and fut_exits='Yes' and dm=:dm) B set A.phcaol =  (A.phcaol + B.cen) where A.account_Name=:account_Name and A.account_track=:account_Track and  A.dm=:dm",nativeQuery = true)
    public void updatePhcVolDBPhcAOLFutExistsAcnt(@Param("account_Name") String account_Name, @Param("account_Track") String account_Track,  @Param("dm") String dm);
    ...
    @Modifying
    @Query(value = "update Phc_Vol A, (select count(emp_name) cen from PHC where trim(lastmcc) =:account_Name and account_Track=:account_Track and proj_type!='Production' and alloc_end_date < last_day(CURDATE()) and fut_exits='Yes' and dm=:dm) B set A.phcaol =  (A.phcaol + B.cen) where A.account_Name=:account_Name and A.account_track=:account_Track and A.dm=:dm",nativeQuery = true)
    public void updatePhcVolDBPhcAOLFutExistsLmcc(@Param("account_Name") String account_Name, @Param("account_Track") String account_Track,  @Param("dm") String dm);
